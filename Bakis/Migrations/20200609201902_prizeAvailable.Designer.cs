...
namespace Bakis.Migrations
{
    ...
    [Migration("20200609201902_prizeAvailable")]
    partial class prizeAvailable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bakis.Infrastructure.Database.Models.ConsumerPrize", b =>
                {
                    b.Property<int>("ConsumerId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ConsumerId", "PrizeId");

                    b.HasIndex("PrizeId");

                    b.ToTable("ConsumerPrize");
                });
            ...
            modelBuilder.Entity("Bakis.Infrastructure.Database.Models.Prize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bakis.Infrastructure.Database.Models.ConsumerPrize", b =>
                {
                    ...
                    b.HasOne("Bakis.Infrastructure.Database.Models.Prize", "Prize")
                        .WithMany("UserPrize")
